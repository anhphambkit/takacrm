                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group @if ($errors->has('phone')) has-error @endif">
                                            ...
                                            {!! Form::text('phone', $user->phone, ['class' => 'form-control', 'id' => 'phone', 'data-counter' => 15]) !!}
                                        </div>
                                        <div class="form-group @if ($errors->has('secondary_phone')) has-error @endif">
                                            ...
                                            {!! Form::text('secondary_phone', $user->secondary_phone, ['class' => 'form-control', 'id' => 'secondary_phone', 'data-counter' => 15]) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">

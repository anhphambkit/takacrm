...
@section('content')
    {!! Form::open(['route' => 'admin.customer.group_customer.create']) !!}
        @php do_action(BASE_FILTER_BEFORE_RENDER_FORM, CUSTOMER_MODULE_SCREEN_NAME, request(), null) @endphp
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="from-actions-bottom-right">{{ trans('plugins-customer::group-customer.create') }}</h4>
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 mb-2 @if ($errors->has('parent_id')) has-error @endif">
                                        ...
                                        {!! Form::select('parent_id', $customerGroups, old('parent_id'), ['class' => 'select2-placeholder-multiple form-control group-customer-list', "id" => "select-group-customer-list" ]) !!}

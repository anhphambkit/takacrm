    ...
    <div class="row">
        <div class="col-md-9 row">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('full_name')) has-error @endif">
                                        ...
                                        {!! Form::text('full_name', $customer->full_name, ['class' => 'form-control', 'id' => 'full_name', 'data-counter' => 255, 'placeholder' => trans('plugins-customer::customer.form.full_name')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('gender')) has-error @endif">
                                        ...
                                        {!! Form::select('gender', $genders, $customer->gender, ['class' => 'select2-placeholder-multiple form-control gender-list', "id" => "select-gender-list" ]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('phone')) has-error @endif">
                                        ...
                                        {!! Form::text('phone', $customer->phone, ['class' => 'form-control', 'id' => 'phone', 'data-counter' => 50, 'placeholder' => trans('plugins-customer::customer.form.phone')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('customer_code')) has-error @endif">
                                        ...
                                        {!! Form::text('customer_code', $customer->customer_code, ['class' => 'form-control', 'id' => 'customer_code', 'data-counter' => 50, 'placeholder' => trans('plugins-customer::customer.form.customer_code')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('tax_code')) has-error @endif">
                                        ...
                                        {!! Form::text('tax_code', $customer->tax_code, ['class' => 'form-control', 'id' => 'tax_code', 'data-counter' => 50, 'placeholder' => trans('plugins-customer::customer.form.tax_code')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('fax')) has-error @endif">
                                        ...
                                        {!! Form::text('fax', $customer->fax, ['class' => 'form-control', 'id' => 'fax', 'data-counter' => 50, 'placeholder' => trans('plugins-customer::customer.form.fax')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('email')) has-error @endif">
                                        ...
                                        {!! Form::text('email', $customer->email, ['class' => 'form-control', 'id' => 'email', 'data-counter' => 120, 'placeholder' => trans('plugins-customer::customer.form.email')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('value')) has-error @endif">
                                        ...
                                        {!! Form::text('value', $customer->value, ['class' => 'form-control', 'id' => 'value', 'data-counter' => 120, 'placeholder' => trans('plugins-customer::customer.form.value')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('description')) has-error @endif">
                                        ...
                                        {!! render_editor('description', $customer->description, true) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('dob')) has-error @endif">
                                        ...
                                        <div class="input-group">
                                            ...
                                            {!! Form::text('dob', $customer->dob ? format_date_time($customer->dob, "Asia/Ho_Chi_Minh", "Y-m-d", "d/m/Y") : "", ['class' => 'form-control pickadate', 'id' => 'dob', 'placeholder' => trans('plugins-customer::customer.form.dob')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('address')) has-error @endif">
                                        ...
                                        {!! Form::textarea('address', $customer->address, ['class' => 'form-control', 'id' => 'address', 'data-counter' => 255, 'placeholder' => trans('plugins-customer::customer.form.address')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('province_city_code')) has-error @endif">
                                        ...
                                        {!! Form::select('province_city_code', $provincesCities, $customer->province_city_code, ['class' => 'select2-placeholder-multiple form-control province_city_code-list', "id" => "select-province_city_code-list" ]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('district_code')) has-error @endif">
                                        ...
                                        {!! Form::select('district_code', [
                                            "male" => "Male",
                                            "female" => "Female",
                                        ], $customer->district_code, ['class' => 'select2-placeholder-multiple form-control district_code-list', "id" => "select-district_code-list" ]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('ward_code')) has-error @endif">
                                        ...
                                        {!! Form::select('ward_code', [
                                            "male" => "Male",
                                            "female" => "Female",
                                        ], $customer->ward_code, ['class' => 'select2-placeholder-multiple form-control ward_code-list', "id" => "select-ward_code-list" ]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('website')) has-error @endif">
                                        ...
                                        {!! Form::text('website', $customer->website, ['class' => 'form-control', 'id' => 'website', 'data-counter' => 255, 'placeholder' => trans('plugins-customer::customer.form.website')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('facebook')) has-error @endif">
                                        ...
                                        {!! Form::text('facebook', $customer->facebook, ['class' => 'form-control', 'id' => 'facebook', 'data-counter' => 255, 'placeholder' => trans('plugins-customer::customer.form.facebook')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('note')) has-error @endif">
                                        ...
                                        {!! Form::textarea('note', $customer->note, ['class' => 'form-control', 'id' => 'note', 'data-counter' => 255, 'placeholder' => trans('plugins-customer::customer.form.note')]) !!}
            ...
            <div class="col-md-4">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('type_reference_data')) has-error @endif">
                                        ...
                                        {!! Form::select('type_reference_data', $typeReferenceData, $customer->type_reference_data, ['class' => 'select2-placeholder-multiple form-control type_reference_data-list', "id" => "select-type_reference_data-list" ]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('introduce_person_id')) has-error @endif">
                                        ...
                                        {!! Form::select('introduce_person_id', $introducePersonIds, $customer->introduce_person_id, ['class' => 'select2-placeholder-multiple form-control introduce_person_id-list', "id" => "select-introduce_person_id-list" ]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('user_manage_id')) has-error @endif">
                                        ...
                                        {!! Form::select('user_manage_id', $users, $customer->user_manage_id, ['class' => 'select2-placeholder-multiple form-control user_manage_id-list', "id" => "select-user_manage_id-list" ]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('customer_group_id')) has-error @endif">
                                        ...
                                        {!! Form::select('customer_group_id[]', $customerGroups, $selectedCustomerGroups, ['class' => 'select2-placeholder-multiple form-control customer_group-list', "id" => "select-customer_group-list", "multiple" => "multiple" ]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('customer_source_id')) has-error @endif">
                                        ...
                                        {!! Form::select('customer_source_id[]', $customerSources, $selectedCustomerSources, ['class' => 'select2-placeholder-multiple form-control customer_source-list', "id" => "select-customer_source-list", "multiple" => "multiple" ]) !!}
                ...
                {{--Custom Attribute--}}
                @include('plugins-custom-attributes::partials.card-custom-attributes', [ 'entityId' => $customer->id ])
        ...
        <div class="col-md-3 right-sidebar">
            ...
            <div class="widget meta-boxes">
                ...
                <div class="widget-body">
                    {!! Form::mediaImage('avatar', $customer->avatar) !!}
...
@section('variable-scripts')
    <script>
        ...
        const INTRODUCE_PERSON_ID = "{!! $customer->introduce_person_id !!}";
        const WARD_CODE_DEFAULT = "{!! $customer->ward_code !!}";
        const DISTRICT_CODE_DEFAULT = "{!! $customer->district_code !!}";
    </script>
@stop

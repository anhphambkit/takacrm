                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 mb-2 @if ($errors->has('customer_job_id')) has-error @endif">
                                            ...
                                            {!! Form::select('customer_job_id[]', $customerGroups, old('customer_job_id'), ['class' => 'select2-placeholder-multiple form-control job_id-list', "id" => "select-job_id-list", "multiple" => "multiple" ]) !!}

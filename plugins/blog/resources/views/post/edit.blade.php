...
@section('content')
    {!! Form::open(['route' => ['admin.blog.post.edit', $post->id]]) !!}
        @php do_action(BASE_FILTER_BEFORE_RENDER_FORM, BLOG_POST_MODULE_SCREEN_NAME, request(), $post) @endphp
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="from-actions-bottom-right">{{ trans('plugins-blog::posts.edit') }}</h4>
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('name')) has-error @endif">
                                        ...
                                        {!! Form::text('name', $post->name, ['class' => 'form-control', 'id' => 'name', 'placeholder' => trans('core-base::forms.name_placeholder'), 'data-counter' => 120]) !!}
                                        {!! Form::error('name', $errors) !!}
                                    </div>
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('slug')) has-error @endif">
                                        {!! apply_filters(BASE_FILTER_SLUG_AREA, BLOG_POST_MODULE_SCREEN_NAME, $post) !!}
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('tag')) has-error @endif">
                                        ...
                                        {!! Form::text('tag', $tags, ['class' => 'form-control', 'id' => 'tags', 'data-role' => 'tagsinput', 'placeholder' => trans('plugins-blog::posts.form.tags_placeholder')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('description')) has-error @endif">
                                        ...
                                        {!! Form::textarea('description', $post->description, ['class' => 'form-control', 'rows' => 4, 'id' => 'description', 'placeholder' => trans('Description'), 'data-counter' => 400]) !!}
            ...
            <div class="col-md-3 right-sidebar">
                ...
                @include('core-base::elements.forms.status', ['selected' => $post->status])
                ...
                @php do_action(BASE_ACTION_META_BOXES, BLOG_POST_MODULE_SCREEN_NAME, 'top', $post) @endphp
                @php do_action(BASE_ACTION_META_BOXES, BLOG_POST_MODULE_SCREEN_NAME, 'side', $post) @endphp
            </div>
        </div>
    {!! Form::close() !!}
@stop
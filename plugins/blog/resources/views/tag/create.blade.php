...
@section('content')
    {!! Form::open(['route' => 'admin.blog.tag.create']) !!}
        @php do_action(BASE_FILTER_BEFORE_RENDER_FORM, BLOG_TAG_MODULE_SCREEN_NAME, request(), null) @endphp
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('slug')) has-error @endif">
                                        {!! apply_filters(BASE_FILTER_SLUG_AREA, BLOG_TAG_MODULE_SCREEN_NAME) !!}
                                    </div>
                                </div>
                                <div class="row">
            ...
            <div class="col-md-3 right-sidebar">
                ...
                @php do_action(BASE_ACTION_META_BOXES, BLOG_TAG_MODULE_SCREEN_NAME, 'top') @endphp
                @php do_action(BASE_ACTION_META_BOXES, BLOG_TAG_MODULE_SCREEN_NAME, 'side') @endphp
            </div>
        </div>
    {!! Form::close() !!}
@stop
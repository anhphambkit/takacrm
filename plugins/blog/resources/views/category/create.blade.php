...
@section('content')
    {!! Form::open(['route' => 'admin.blog.category.create']) !!}
        @php do_action(BASE_FILTER_BEFORE_RENDER_FORM, BLOG_CATEGORY_MODULE_SCREEN_NAME, request(), null) @endphp
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="from-actions-bottom-right">{{ trans('plugins-blog::categories.create') }}</h4>
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('slug')) has-error @endif">
                                        {!! apply_filters(BASE_FILTER_SLUG_AREA, BLOG_CATEGORY_MODULE_SCREEN_NAME) !!}
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6 mb-6">
                                        <label class="control-label required" for="role">Is Default</label>
                                        {!! Form::onOff('is_default', old('is_default')) !!}
                                    </div>
                                    <div class="form-group col-md-6 mb-6">
                                        <label class="control-label required" for="role">Is Featured</label>
                                        {!! Form::onOff('is_featured', old('is_featured')) !!}
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('parent_id')) has-error @endif">
                                        ...
                                        {!! Form::select('parent_id', $categories, null, ['class' => 'form-control roles-list']) !!}
                                    </div>
                                </div>
                                <div class="row">
            ...
            <div class="col-md-3 right-sidebar">
                ...
                @php do_action(BASE_ACTION_META_BOXES, BLOG_CATEGORY_MODULE_SCREEN_NAME, 'top') @endphp
                @php do_action(BASE_ACTION_META_BOXES, BLOG_CATEGORY_MODULE_SCREEN_NAME, 'side') @endphp
            </div>
        </div>
    {!! Form::close() !!}
@stop
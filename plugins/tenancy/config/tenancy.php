...
return [
    'models' => [
        ...
        // Must implement \Plugins\Tenancy\Contracts\Hostname
        'hostname' => \Plugins\Tenancy\Models\Hostname::class,

        // Must implement \Plugins\Tenancy\Contracts\Website
        'website' => \Plugins\Tenancy\Models\Website::class
    ],
    /**
    ...
    'middleware' => [
        ...
        \Plugins\Tenancy\Middleware\EagerIdentification::class,

        // The hostname actions middleware (redirects, https, maintenance).
        \Plugins\Tenancy\Middleware\HostnameActions::class,
    ],
    'website' => [
        /**
         ...
         */
        'random-id-generator' => Plugins\Tenancy\Generators\Uuid\ShaGenerator::class,

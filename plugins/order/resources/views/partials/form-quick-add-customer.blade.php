                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('full_name')) has-error @endif">
                                        ...
                                        {!! Form::text('full_name', old('full_name'), ['class' => 'form-control', 'data-counter' => 255, 'placeholder' => trans('plugins-customer::customer.form.full_name')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('phone')) has-error @endif">
                                        ...
                                        {!! Form::text('phone', old('phone'), ['class' => 'form-control', 'data-counter' => 50, 'placeholder' => trans('plugins-customer::customer.form.phone')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('facebook')) has-error @endif">
                                        ...
                                        {!! Form::text('facebook', old('facebook'), ['class' => 'form-control', 'data-counter' => 255, 'placeholder' => trans('plugins-customer::customer.form.facebook')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('customer_code')) has-error @endif">
                                        ...
                                        {!! Form::text('customer_code', old('customer_code'), ['class' => 'form-control', 'data-counter' => 50, 'placeholder' => trans('plugins-customer::customer.form.customer_code')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('tax_code')) has-error @endif">
                                        ...
                                        {!! Form::text('tax_code', old('tax_code'), ['class' => 'form-control', 'data-counter' => 50, 'placeholder' => trans('plugins-customer::customer.form.tax_code')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('fax')) has-error @endif">
                                        ...
                                        {!! Form::text('fax', old('fax'), ['class' => 'form-control', 'data-counter' => 50, 'placeholder' => trans('plugins-customer::customer.form.fax')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('email')) has-error @endif">
                                        ...
                                        {!! Form::text('email', old('email'), ['class' => 'form-control', 'data-counter' => 120, 'placeholder' => trans('plugins-customer::customer.form.email')]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('value')) has-error @endif">
                                        ...
                                        {!! Form::text('value', old('value'), ['class' => 'form-control', 'data-counter' => 120, 'placeholder' => trans('plugins-customer::customer.form.value')]) !!}

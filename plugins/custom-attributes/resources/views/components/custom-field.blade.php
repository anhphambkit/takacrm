...
<div class="{{ $classFieldWrapper }} @if ($errors->has($customAttributeEntity->slug)) has-error @endif">
    ...
    @switch($customAttributeEntity->type_render)
        @case(str_slug(\Plugins\CustomAttributes\Contracts\CustomAttributeConfig::REFERENCE_CUSTOM_ATTRIBUTE_TYPE_RENDER_TEXT_INPUT, '_'))
            {!! Form::text("cf_$customAttributeEntity->slug", !empty(old("cf_$customAttributeEntity->slug")) ? old("cf_$customAttributeEntity->slug") : ($customAttributeEntityValues->isNotEmpty() ? $customAttributeEntityValues->first()->value : null), ['class' => 'form-control', 'id' => "custom-attribute-{$customAttributeEntity->slug}", 'placeholder' => $customAttributeEntity->name ]) !!}
            @break
        ...
        @case(str_slug(\Plugins\CustomAttributes\Contracts\CustomAttributeConfig::REFERENCE_CUSTOM_ATTRIBUTE_TYPE_RENDER_NUMBER_INPUT, '_'))
            {!! Form::number("cf_$customAttributeEntity->slug", !empty(old("cf_$customAttributeEntity->slug")) ? old("cf_$customAttributeEntity->slug") : ($customAttributeEntityValues->isNotEmpty() ? $customAttributeEntityValues->first()->value : null), ['class' => 'form-control', 'type' => 'number', 'id' => "custom-attribute-{$customAttributeEntity->slug}", 'placeholder' => $customAttributeEntity->name ]) !!}
            @break
        ...
        @case(str_slug(\Plugins\CustomAttributes\Contracts\CustomAttributeConfig::REFERENCE_CUSTOM_ATTRIBUTE_TYPE_RENDER_TEXTAREA, '_'))
            {!! render_editor("cf_$customAttributeEntity->slug", !empty(old("cf_$customAttributeEntity->slug")) ? old("cf_$customAttributeEntity->slug") : ($customAttributeEntityValues->isNotEmpty() ? $customAttributeEntityValues->first()->value : null), true) !!}
            @break
        ...
        @case(str_slug(\Plugins\CustomAttributes\Contracts\CustomAttributeConfig::REFERENCE_CUSTOM_ATTRIBUTE_TYPE_RENDER_URL_INPUT, '_'))
            {!! Form::text("cf_$customAttributeEntity->slug", !empty(old("cf_$customAttributeEntity->slug")) ? old("cf_$customAttributeEntity->slug") : ($customAttributeEntityValues->isNotEmpty() ? $customAttributeEntityValues->first()->value : null), ['class' => 'form-control', 'id' => "custom-attribute-{$customAttributeEntity->slug}", 'placeholder' => 'http://example.com' ]) !!}
            @break
        ...
        @case(str_slug(\Plugins\CustomAttributes\Contracts\CustomAttributeConfig::REFERENCE_CUSTOM_ATTRIBUTE_TYPE_RENDER_DATE_TIME_INPUT, '_'))
            {!! Form::text("cf_$customAttributeEntity->slug", !empty(old("cf_$customAttributeEntity->slug")) ? old("cf_$customAttributeEntity->slug") : ($customAttributeEntityValues->isNotEmpty() ? ($customAttributeEntityValues->first()->value ? $customAttributeEntityValues->first()->value : '') : null),
        ...
        @case(str_slug(\Plugins\CustomAttributes\Contracts\CustomAttributeConfig::REFERENCE_CUSTOM_ATTRIBUTE_TYPE_RENDER_SINGLE_SELECT, '_'))
            ...
            @endphp
            {!! Form::select("cf_$customAttributeEntity->slug", $customAttributeEntityOptions, !empty(old("cf_$customAttributeEntity->slug")) ? old("cf_$customAttributeEntity->slug") : ($customAttributeEntityValues->isNotEmpty() ? $customAttributeEntityValues->first()->value : null),
        ...
        @case(str_slug(\Plugins\CustomAttributes\Contracts\CustomAttributeConfig::REFERENCE_CUSTOM_ATTRIBUTE_TYPE_RENDER_MULTIPLE_SELECT, '_'))
            {!! Form::select("cf_{$customAttributeEntity->slug}[]", $customAttributeEntity->attributeOptions()->pluck('option_text', 'id'), !empty(old("cf_$customAttributeEntity->slug")) ? old("cf_$customAttributeEntity->slug") : ($customAttributeEntityValues->isNotEmpty() ? $customAttributeEntityValues->pluck('value') : []),
        ...
        @case(str_slug(\Plugins\CustomAttributes\Contracts\CustomAttributeConfig::REFERENCE_CUSTOM_ATTRIBUTE_TYPE_RENDER_CHECKBOX, '_'))
            @foreach($customAttributeEntity->attributeOptions()->pluck('option_text', 'id') as $customAttributeOptionId => $customAttributeOption)
                {!! Form::onOffPretty("cf_{$customAttributeEntity->slug}[{$customAttributeOptionId}]", !empty(old("cf_{$customAttributeEntity->slug}[{$customAttributeOptionId}]")) ? old("cf_$customAttributeEntity->slug") :
        ...
        @case(str_slug(\Plugins\CustomAttributes\Contracts\CustomAttributeConfig::REFERENCE_CUSTOM_ATTRIBUTE_TYPE_RENDER_RADIO, '_'))
            @foreach($customAttributeEntity->attributeOptions()->pluck('option_text', 'id') as $customAttributeOptionId => $customAttributeOption)
                {!! Form::radioPretty("cf_{$customAttributeEntity->slug}", !empty(old("cf_$customAttributeEntity->slug")) ? old("cf_$customAttributeEntity->slug") :

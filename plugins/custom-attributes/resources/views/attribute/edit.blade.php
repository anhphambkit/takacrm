...
@section('content')
    {!! Form::open(['route' => ['admin.custom-attributes.manage-attribute.edit', $attributeValue->custom_attribute_id, $attributeValue->id ]]) !!}
        @php do_action(BASE_FILTER_BEFORE_RENDER_FORM, CUSTOM_ATTRIBUTES_MODULE_SCREEN_NAME, request(), $attributeValue) @endphp
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('name')) has-error @endif">
                                        ...
                                        {!! Form::text('name', $attributeValue->name, ['class' => 'form-control', 'id' => 'name', 'placeholder' => trans('core-base::forms.name_placeholder'), 'data-counter' => 120]) !!}
                                ...
                                <div class="row">
                                    @if($typeRender === str_slug(\Plugins\CustomAttributes\Contracts\CustomAttributeConfig::REFERENCE_CUSTOM_ATTRIBUTE_TYPE_RENDER_COLOR_PICKER, '_'))
                                        <div class="form-group col-md-12 mb-2 @if ($errors->has('name')) has-error @endif">
                                            ...
                                            {!! Form::text('value', $attributeValue->value, ['class' => 'form-control minicolors color-picker-custom', 'id' => 'value',
            ...
            <div class="col-md-3 right-sidebar">
                ...
                @include('core-base::elements.forms.status', ['selected' => $attributeValue->status])
                {{-- Image--}}
                <div class="widget meta-boxes">
                    ...
                    <div class="widget-body">
                        {!! Form::mediaImage('image_feature', $attributeValue->image_feature, [ 'action' => 'select-image' ]) !!}
                        {!! Form::error('image_feature', $errors) !!}
                    </div>
                </div>
                {{--End Image--}}
                @php do_action(BASE_ACTION_META_BOXES, CUSTOM_ATTRIBUTES_MODULE_SCREEN_NAME, 'top', $attributeValue) @endphp
                @php do_action(BASE_ACTION_META_BOXES, CUSTOM_ATTRIBUTES_MODULE_SCREEN_NAME, 'side', $attributeValue) @endphp
            </div>
        </div>
    {!! Form::close() !!}
@stop
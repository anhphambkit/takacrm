    ...
    {!! Form::open(['route' => ['admin.product.unit.edit', $paymentMethod->id]]) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-3 right-sidebar">
                ...
                @php do_action(BASE_ACTION_META_BOXES, PRODUCT_MODULE_SCREEN_NAME, 'top', $paymentMethod) @endphp
                @php do_action(BASE_ACTION_META_BOXES, PRODUCT_MODULE_SCREEN_NAME, 'side', $paymentMethod) @endphp
            </div>
        </div>
    {!! Form::close() !!}
@stop

...
@section('content')
    {!! Form::open(['route' => ['admin.product.coupon.edit', $coupon->id], 'id' => 'coupon-form']) !!}
        @php do_action(BASE_FILTER_BEFORE_RENDER_FORM, PRODUCT_MODULE_COUPON_SCREEN_NAME, request(), $coupon) @endphp
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="from-actions-bottom-right">{{ trans('plugins-product::coupon.edit') }}</h4>
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="form-group col-md-4 mb-2 @if ($errors->has('start_date')) has-error @endif">
                                        ...
                                        <div class="input-group">
                                            ...
                                            {!! Form::text('start_date', $coupon->start_date , ['class' => 'form-control pickadate', 'id' => 'start_date', 'placeholder' => '1993-03-23']) !!}
                                        </div>
                                    ...
                                    <div class="form-group col-md-4 mb-2 @if ($errors->has('end_date')) has-error @endif">
                                        ...
                                        <div class="input-group">
                                            ...
                                            {!! Form::text('end_date', $coupon->end_date, ['class' => 'form-control pickadate', 'id' => 'end_date', 'placeholder' => '1993-03-23']) !!}
                                        </div>
                                    ...
                                    <div class="form-group col-md-4 mb-2 @if ($errors->has('number')) has-error @endif">
                                        ...
                                        {!! Form::text('number', $coupon->number, ['class' => 'form-control mask-number-mask-input-discount', 'id' => 'number', 'placeholder' => trans('Numbers'), 'data-counter' => 120]) !!}
                                        {!! Form::error('number', $errors) !!}
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('product_category')) has-error @endif">
                                        <label class="control-label required" for="role">Product Category</label>
                                        {!! Form::select('product_category', $categories, $coupon->product_category, ['class' => 'form-control', 'id' => 'product_category']) !!}
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12 mb-2 @if ($errors->has('name')) has-error @endif">
                                        <label for="name">{{ trans('core-base::forms.name') }}</label>
                                        {!! Form::text('name', $coupon->name, ['class' => 'form-control', 'id' => 'name', 'placeholder' => trans('core-base::forms.name_placeholder'), 'data-counter' => 120]) !!}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 mb-6">
                                        ...
                                        {!! Form::onOffPretty('is_all_product', $coupon->is_all_product, ['id' => 'is_all_product']) !!}
                                    </div>
                                    <div class="form-group col-md-4 mb-2">
                                        <label for="number">{{ trans('Coupon Type') }}</label>
                                        <div class="clearfix"></div>
                                        {!! Form::radioPretty('coupon_type', $coupon->coupon_type, 'Money', ['icon' => 'fas fa-dollar-sign']) !!}
                                        {!! Form::radioPretty('coupon_type', $coupon->coupon_type, 'Percent',['icon' => 'fas fa-percent'], 1) !!}
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4 @if ($errors->has('coupon_value')) has-error @endif">
                                        ...
                                        {!! Form::text('coupon_value', $coupon->coupon_value, ['class' => 'form-control', 'id' => 'coupon_value', 'placeholder' => trans('Numbers'), 'data-counter' => 120]) !!}
                    ...
                    @php do_action(BASE_ACTION_META_BOXES, PRODUCT_MODULE_COUPON_SCREEN_NAME, 'advanced', $coupon) @endphp
                </div>
            </div>
